package com.example.lineandcircledraw_ex;
...
//        setContentView(R.layout.activity_main);
        ...
        myGraphicView.setLayoutParams(params);
    ...
    private static class MyGraphicView extends View
    {
        ...
        public MyGraphicView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes)
        {
